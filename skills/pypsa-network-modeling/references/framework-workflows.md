...
- costs/data (pypsa-data-pipelines) -> `data: costs: version` pin; overrides via `costs: overwrites:` | `capital_cost:` | `marginal_cost:` | `custom_cost_fn` CSV; atlite cutouts configured, not hand-built.
